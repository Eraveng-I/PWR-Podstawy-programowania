...
void DodajImie(char* buf, char**& wskaznik, int d)
{
    ...
    //zamiana
    nowaprzestrzen = new char* [pozycja + 2];
    memcpy(nowaprzestrzen, wskaznik, pozycja * sizeof(char*));
    
    delete wskaznik;
    wskaznik = nowaprzestrzen;

    //wskaznik[pozycja] = strdup( buf);
    //zamiana
    wskaznik[pozycja] = new char[strlen(buf)+1];
    strcpy(wskaznik[pozycja], buf);
...
void UsuniecieIndeksu(int ktory, char**& wskaznik)
{
    ...
    //zamiana
    nowaprzestrzen = new char* [pozycja];
    memcpy(nowaprzestrzen, wskaznik, pozycja * sizeof(char*));
